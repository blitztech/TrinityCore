...
SpellImplicitTargetInfo::StaticData  SpellImplicitTargetInfo::_data[TOTAL_SPELL_TARGETS] =
{
    ...
    {TARGET_OBJECT_TYPE_UNIT, TARGET_REFERENCE_TYPE_CASTER, TARGET_SELECT_CATEGORY_CONE,    TARGET_CHECK_ENEMY,    TARGET_DIR_FRONT},       // 134
...
bool SpellInfo::_IsPositiveTarget(uint32 targetA, uint32 targetB)
{
    ...
    switch (targetA)
    {
        ...
        case TARGET_UNIT_LINE_ENEMY_134:
            return false;
        default:
            break;
    }
